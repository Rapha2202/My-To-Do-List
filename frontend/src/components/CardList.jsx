  ...
  return (
    <div className="w-40 min-h-40 border-2 border-secondary-light dark:border-secondary-dark flex flex-col justify-center">
      <div>
        ...
        <button
          type="button"
          className="border-2 rounded-full mx-2 mt-4 border-secondary-light dark:border-secondary-dark mb-2 hover:scale-105 hover:transform hover:transition-all hover:duration-300 hover:ease-in-out"
          onClick={() => {

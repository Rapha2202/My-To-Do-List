    ...
    <div className="min-h-screen flex flex-col text-center items-center justify-center">
      <div className="p-8 mt-8 md:mt-0 md:w-[60%]">
        ...
        <p>
          ...
          du site et des services par _______________ et de définir les
          ...
          compris les CGU et je les accepte ». En cas de non-acceptation des CGU
          stipulées dans le présent contrat, l'Utilisateur se doit de renoncer à
          l'accès des services proposés par le site. http://localhost:3000/ se
        ...
        <p>
          ...
          http://localhost:3000/ est assurée par Foulon-Binet Raphaël.
          <br />
          Adresse e-mail raphael.foulonbinet@gmail.com.
        </p>
        ...
        <p>
          Le site http://localhost:3000/ permet à l'Utilisateur un accès gratuit
          aux services suivants : Le site internet propose les services suivants
          :
          <br />
          création, modification et suppression d'une liste, création,
          modification et suppression de tache, ajout d'utilisateur sur une
          liste
          <br />
          ...
          responsabilité de http://localhost:3000/. Dans ces cas, l’Utilisateur
        ...
        <p>
          ...
          exerce ce droit :
          <br />
          par mail à l'adresse email raphael.foulonbinet@gmail.com
        </p>
        ...
        <p>
          ...
          http://localhost:3000/ sont réputées fiables mais le site ne garantit
          ...
          le site http://localhost:3000/ ne peut être tenu responsable de la
          ...
          <br />
          Le site http://localhost:3000/ ne peut être tenu pour responsable
        ...
        <p>
          ...
          http://localhost:3000/. Ce dernier n’a pas de contrôle sur les pages
        ...
        <p>
          ...
          qui sont nécessaires à l’utilisation du site http://localhost:3000/.
